...
export function CreateProductForm() {
  ...
  function submit(event: React.FormEvent<HTMLFormElement>) {
    ...
    setErrors({})
    setSubmitting(true)
    if (!window.confirm(`Add ${parsed.data.name} and its opening inventory?`)) { setSubmitting(false); return }
